...
async def async_setup_entry(hass: HomeAssistant, config_entry: ConfigEntry, async_add_entities) -> None:
	...
	async_add_entities([
		JablotronQueryButtonEntity(cu.query, cu),
		JablotronSyncClockButtonEntity(cu.sync_clock_button, cu),
	], True)
...
class JablotronSyncClockButtonEntity(JablotronEntity, ButtonEntity):
